...
export const BlogPostContentSkeleton: React.FC = () => {
  return (
    <div className="max-w-4xl mx-auto px-4 py-28 animate-pulse">
      {/* Header Skeleton */}
      <div className="mb-12">
      ...
      {/* Content Skeleton */}
      <div className="prose prose-xl max-w-none prose-headings:border-2 prose-headings:border-black prose-headings:font-bold prose-p:border-2 prose-p:border-black prose-p:p-4 prose-li:border-2 prose-li:border-black prose-pre:border-2 prose-pre:border-black prose-code:border-2 prose-code:border-black">
