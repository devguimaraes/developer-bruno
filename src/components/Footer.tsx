        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-7 sm:gap-8 relative z-10">
          <div className="flex flex-col items-center md:items-start gap-2 text-center md:text-left">
            <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-4">
              ...
              <span className="type-body text-xs sm:text-sm uppercase text-white/60">{footerData.copyright.toUpperCase()}</span>
            </div>
            <span className="type-ui-label text-xs sm:text-sm text-stone-500">Built with precision</span>
          </div>
