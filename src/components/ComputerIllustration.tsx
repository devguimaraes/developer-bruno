        ...
        <div className="w-full bg-[#2a2a2a] border-4 border-black p-2 pb-8 shadow-inner relative">
          ...
          <div className="bg-[#0a0a0a] w-full aspect-[5/4] border-2 border-[#4a4a4a] relative overflow-hidden p-4 font-mono text-sm text-green-400 shadow-[inset_0_0_20px_rgba(0,0,0,0.8)] scanlines-crt">
            ...
            <div className="space-y-3 relative z-10 text-xs md:text-sm">
              <div className="typing-effect flex items-center">
                <span className="text-brutal-orange mr-2">root@bruno:~$</span>
                <Typewriter
                  text="iniciar portfolio_v2.exe"
                  className="text-white inline-block"
                  speed={0.05}
                  variant="mechanical"
                />
              </div>
              <div className="text-green-600 pl-4 border-l border-green-800 flex flex-col gap-1">
                <span>
                  <Typewriter
                    text="> Carregando assets criativos... [OK]"
                    delay={1.5}
                    speed={0.02}
                    variant="mechanical"
                  />
                ...
                <span>
                  <Typewriter
                    text="> Compilando componentes React... [OK]"
                    delay={2.5}
                    speed={0.02}
                    variant="mechanical"
                  />
                ...
                <span>
                  <Typewriter
                    text="> Injetando estilo: NEO_BRUTALISMO... [OK]"
                    delay={3.5}
                    speed={0.02}
                  />
                </span>
              ...
              <div className="mt-4">
                ...
                <motion.span
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
                  transition={{ delay: 4.5, duration: 0 }}
                >
                  <span className="animate-pulse bg-green-500 text-black px-1">
                    _
                  </span>
                </motion.span>
              </div>
